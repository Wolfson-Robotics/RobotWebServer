...
public class ServerConfig {
    ...
    public static final Class<?>[] ROBOT_DEVICE_TYPES = { DcMotorEx.class, DcMotorEx.class, DcMotorImpl.class, DcMotorImplEx.class, Servo.class, ServoImpl.class, ServoImplEx.class };
