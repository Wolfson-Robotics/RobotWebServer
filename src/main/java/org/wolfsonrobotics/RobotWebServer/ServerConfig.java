...
import org.wolfsonrobotics.RobotWebServer.fakerobot.DcMotor;
...
public class ServerConfig {
    ...
    public static final String CONTROL_HUB_STORAGE = "";
    public static final String[] COMM_METHODS = null;
    public static final String[] EXCLUDED_COMM_METHODS = { "getCameraFeed", "populateTelemetry" };

    public static final int DEFAULT_SOCKET_MSG_FREQUENCY = 1000;
